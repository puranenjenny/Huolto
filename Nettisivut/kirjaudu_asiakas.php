      ...
      <div class="text-center lomake_tausta2">
        <form method="POST" action="asiakas_kirjautumiskoodi.php" class="form">
          <div class="form-group">
            ...
            <input id="asiakas_tunnus" type="asiakas_tunnus" name="asiakas_tunnus" required class="form-control text-center" placeholder="mmeikalainen"><br>
          </div>
          <div class="form-group">
            <label for="asiakas_salasana">Salasana *</label>
            <input id="asiakas_salasana" type="asiakas_salasana" name="asiakas_salasana" required class="form-control text-center" placeholder="salasana123"><br>
          </div>
