...
<head>
  ...
  <meta http-equiv="refresh" content="2;url=http://localhost/fullstack/Huolto/Nettisivut/ui-huoltohenkilot.php" />
</head>
    ...
    try {
      if (isset($_POST['submit'])) {
        ...
        //HOX! Lisäysjärjestyksellä väliä, että toimii koodi. 
         ...
         $lisaa_tyontekija->execute([$tunnus, $kryptattu_salasana, $kayttaja, $rooli_id]);
