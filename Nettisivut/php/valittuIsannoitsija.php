...
if(isset($_GET['id'])){
    ...
    $query = "SELECT  isannoitsija_id, etunimi, sukunimi, email, puhelin
    FROM isannoitsijat
    ...
    $JSON_paivita_isannoitsija.= '{"id":"' .$rivi['isannoitsija_id'] . '", "Etunimi":"' . $rivi['etunimi'] . '", "Sukunimi":"' . $rivi['sukunimi'] . '", "Email":"' . $rivi['email'] . '", "Puhelin":"' . $rivi['puhelin'] . '"}]}';
