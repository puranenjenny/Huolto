...
if(isset($_GET['id'])){
    $asukas_id = $_GET['id'];
    $query = "SELECT asukkaat.asukas_id , asukkaat.etunimi, asukkaat.sukunimi, taloyhtiot.nimi, asukkaat.rappu
    FROM asukkaat
    ...
    $JSON_paivita_asukas.= '{"id":"' .$rivi['asukas_id'] . '", "Etunimi":"' . $rivi['etunimi'] . '", "Sukunimi":"' . $rivi['sukunimi'] . '", "Taloyhtio":"' . $rivi['nimi'] . '", "Rappu":"' . $rivi['rappu'] . '"}]}';
