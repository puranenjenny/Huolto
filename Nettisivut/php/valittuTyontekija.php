...
if(isset($_GET['id'])){
    ...
    $query = "SELECT tyontekijat.tyontekija_id, tyontekijat.etunimi, tyontekijat.sukunimi, tyontekijat.email, tyontekijat.puhelin, tyontekijat.tyontekijan_tilanne_id, tyontekijan_tilanne.tyontekijan_tilanne, kayttajat.rooli_id, roolit.rooli
    FROM tyontekijat
    ...
    $rivi = $data->fetch(PDO::FETCH_ASSOC);
     ...
     $JSON_paivita_tyontekija.= '{"id":"' .$rivi['tyontekija_id'] . '", "Etunimi":"' . $rivi['etunimi'] . '", "Sukunimi":"' . $rivi['sukunimi'] . '", "Email":"' . $rivi['email'] . '", "Puhelin":"' . $rivi['puhelin'] . '", "Tilanne-id":"' . $rivi['tyontekijan_tilanne_id'] . '", "Tilanne":"' . $rivi['tyontekijan_tilanne'] . '", "rooli-id":"' . $rivi['rooli_id'] . '", "rooli":"' . $rivi['rooli'] . '"}]}';
