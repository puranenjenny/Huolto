...
--
-- Host: 127.0.0.1
-- Generation Time: 27.04.2023 klo 10:16
...
(3, 3, 'asiakas1', 'asiakkaantie 1', 'asiakas@jotain.fi', 123456789, 'asiakas1', 'asiakas1', 3, 2);
...
CREATE TABLE `tyotehtavat` (
  ...
  `tyonvaiheID` int(11) NOT NULL,
  `kayttajaID` int(11) NOT NULL,
  `tyonkuvaus` varchar(200) NOT NULL,
  `viankorjaaja` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tyotehtavat` (`tyotehtavaID`, `vikailmoitusID`, `taloyhtioID`, `tyonvaiheID`, `kayttajaID`, `tyonkuvaus`, `viankorjaaja`) VALUES
(2, 1, 2, 2, 2, '', ''),
(3, 2, 2, 3, 2, 'Työ tehty. Paikattiin vuoto taloyhtiö testi123.', 'Pertti ');
...
INSERT INTO `vikailmoitus` (`vikailmoitusID`, `kayttajaID`, `taloyhtioID`, `vika`, `kiireellisyys`, `nimi`, `osoite`) VALUES
(1, 2, 2, 'testitestitesti', 'Ei paniikkia', 'Testi1', 'testitestintie 1'),
(2, 2, 2, 'toimiikostämä', 'kohtalainen', 'Pekka ranta', 'asunto 5');
...
ALTER TABLE `tyotehtavat`
  ...
  ADD KEY `viankorjaaja` (`viankorjaaja`);
...
ALTER TABLE `vikailmoitus`
  ...
  ADD KEY `asiakasID` (`kayttajaID`,`taloyhtioID`),
  ADD KEY `taloyhtioID` (`taloyhtioID`);
...
--
ALTER TABLE `tyotehtavat`
  MODIFY `tyotehtavaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `vikailmoitus`
  ADD CONSTRAINT `vikailmoitus_ibfk_1` FOREIGN KEY (`kayttajaID`) REFERENCES `kayttajat` (`kayttajaID`),
